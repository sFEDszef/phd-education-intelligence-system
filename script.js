...
const translations = {
  en: {
    ...
    brandTagline: "Public research-alignment intelligence for education applicants",
    navFieldMap: "Field Map",
    navSupervisorDatabase: "Supervisor & Researcher Database",
    navRecommendation: "AI Recommendation",
    heroTitle: "PhD Education Intelligence System",
    heroDescription:
      "PEIS helps applicants explore education research areas, review verified academic profiles, and generate transparent research-alignment recommendations without any backend, external API, or personal data storage.",
    metricFields: "Research Fields",
    metricSupervisors: "Academic Profiles",
    ...
    databaseTitle: "Potential PhD Supervisors & Education Researchers",
    databaseDescription: "Search, filter, sort, and page through verified profiles of potential supervisors and education-related academics.",
    coverageNoticeTitle: "Supervisor Coverage & Admission Status",
    coverageNoticeBodyOne:
      "This database includes potential PhD supervisors and education-related academics to help applicants identify scholars whose research may align with their interests. Inclusion does not necessarily indicate current eligibility to supervise doctoral students or the availability of PhD positions. Supervision eligibility and recruitment availability may vary by academic rank, programme, department, and admission cycle.",
    coverageNoticeBodyTwo:
      "Where reliable official information is available, the system indicates supervision and recruitment status. Information that cannot be verified through public official sources is marked as ‘Not Verified’. Research alignment does not imply doctoral supervision eligibility, and confirmed supervisor status does not necessarily mean that the academic is recruiting students in the current admission cycle. Applicants should verify current information through official university sources, current admission materials, or direct contact with the academic/department before applying.",
    searchLabel: "Search academics",
    ...
    tableSupervisor: "Academic",
    tableResearchFit: "Research Alignment",
    tableMethod: "Method",
    ...
    recommendationDescription: "Local rule-based scoring converts applicant input into tags and ranks research alignment only.",
    ...
    generateMatches: "Generate Top 5 Research Matches",
    structuredTags: "Structured Tags",
    tagsEmpty: "Enter research interests to generate tags.",
    topMatches: "Top Research Matches",
    researchMatchNotice: "Research Match measures topic and methodology alignment only. It is not a measure of supervision eligibility, recruitment availability, or admission probability.",
    matchesEmpty: "No verified academic profiles are available for research matching yet.",
    projectInformationLabel: "Project Information",
    projectInformationTitle: "About This Project",
    projectInformationDescription:
      "This independent academic project supports Education PhD applicants through a structured potential-supervisor and researcher database, research-field exploration tools and transparent research-matching functions. Data are compiled from official university sources and are periodically reviewed.",
    ...
    footerNotice:
      "PEIS is a static academic intelligence system. Academic profiles must be verified against official university sources before publication.",
    homepage: "Personal homepage",
    departmentPage: "Department page",
    source: "Source",
    supervisorCount: (count) => `${count} verified academic profile${count === 1 ? "" : "s"}`,
    noSupervisorMatch:
      "No verified academic profiles match the current filters. Add records through data/template_supervisor.json after source verification.",
    ...
    relevanceSuffix: "research activity",
    tierSuffix: "tier",
    ...
    supervisionLabel: "PhD Supervision",
    supervisionConfirmed: "Confirmed",
    supervisionNotAccepting: "Not Accepting",
    supervisionNotVerified: "Not Verified",
    availabilityLabel: "Current Availability",
    availabilityNotAccepting: "Not Accepting",
    availabilityNotVerified: "Not publicly verified",
    researchMatchLabel: "Research Match",
    phdStatusUnknown: "Not Verified",
  ...
  zh: {
    ...
    brandTagline: "面向教育学博士申请者的公共研究匹配情报工具",
    navFieldMap: "领域地图",
    navSupervisorDatabase: "潜在导师与教育学者数据库",
    navRecommendation: "AI 推荐",
    heroTitle: "博士教育申请情报系统",
    heroDescription:
      "PEIS 帮助申请者探索教育研究领域、查阅已核验学者资料，并在无后端、无外部 API、无个人数据存储的前提下生成透明的研究匹配推荐。",
    metricFields: "研究领域",
    metricSupervisors: "学者资料",
    metricStatic: "纯静态前端",
    moduleOne: "模块 1",
    moduleTwo: "模块 2",
    moduleThree: "模块 3",
    ...
    expandAll: "全部展开",
    collapseAll: "全部收起",
    databaseTitle: "潜在导师与教育学者数据库",
    databaseDescription: "搜索、筛选、排序并分页浏览已核验的潜在导师与教育相关学者资料。",
    coverageNoticeTitle: "导师收录与招生资格说明",
    coverageNoticeBodyOne:
      "本系统收录的是与教育研究相关的潜在博士导师及学者，旨在帮助申请者发现研究方向匹配的学者，并不代表所有收录人员均具有当前博士招生资格或招生名额。导师的博士指导资格、招生状态及名额可能因职级、院系规定、博士项目及申请年度而变化。",
    coverageNoticeBodyTwo:
      "系统会在有可靠官方信息的情况下标注导师资格与招生状态；对于尚无法通过公开官方来源确认的信息，将标记为“未核实（Not Verified）”。研究方向匹配不等同于具有博士招生资格，“已确认博士导师”亦不代表当前申请年度一定有招生名额。申请前请务必通过大学官网、当年度招生信息或直接联系导师/院系进行最终确认。",
    searchLabel: "搜索潜在导师与学者",
    ...
    recommendationDescription: "本地规则评分会把申请者输入转换为结构化标签，并仅按研究方向匹配度排序。",
    interestLabel: "研究兴趣",
    interestPlaceholder: "示例：AI 支持的自我调节学习、学习分析、混合方法、高等教育研究",
    methodPreferenceLabel: "方法偏好",
    regionPreferenceLabel: "地区偏好",
    noPreference: "无偏好",
    generateMatches: "生成前 5 位研究匹配",
    structuredTags: "结构化标签",
    tagsEmpty: "输入研究兴趣后生成标签。",
    topMatches: "最佳研究匹配",
    researchMatchNotice: "研究匹配仅衡量主题与方法的相关性，不代表博士指导资格、当前招生状态或录取概率。",
    matchesEmpty: "目前还没有可用于研究匹配的已核验学者资料。",
    projectInformationLabel: "项目信息",
    projectInformationTitle: "关于本项目",
    projectInformationDescription:
      "本独立学术项目通过结构化潜在导师与教育学者数据库、研究领域探索工具和透明的研究匹配功能，为教育学博士申请者提供支持。数据整理自大学官方来源，并进行定期复核。",
    creatorLabel: "创建者：",
    ...
    footerNotice: "PEIS 是静态学术情报系统。学者资料发布前必须通过大学官方来源核验。",
    homepage: "个人主页",
    departmentPage: "院系页面",
    source: "来源",
    supervisorCount: (count) => `${count} 份已核验学者资料`,
    noSupervisorMatch: "当前筛选条件下没有已核验学者资料。请按 data/template_supervisor.json 核验来源后添加记录。",
    ...
    scoreMethod: "方法",
    scoreEnvironment: "环境",
    supervisionLabel: "博士指导资格",
    supervisionConfirmed: "已确认博士指导资格",
    supervisionNotAccepting: "暂不招生",
    supervisionNotVerified: "博士指导资格未核实",
    availabilityLabel: "当前招生状态",
    availabilityNotAccepting: "暂不招生",
    availabilityNotVerified: "未公开核实",
    researchMatchLabel: "研究匹配",
    phdStatusUnknown: "博士指导资格未核实",
...
const supervisionPresentation = (supervisor) => {
  const status = getStatus(supervisor);
  if (status === "confirmed") return { label: t("supervisionConfirmed"), className: "confirmed" };
  if (status === "not_accepting") return { label: t("supervisionNotAccepting"), className: "closed" };
  return { label: t("supervisionNotVerified"), className: "not-verified" };
};

const availabilityPresentation = (supervisor) =>
  getStatus(supervisor) === "not_accepting" ? t("availabilityNotAccepting") : t("availabilityNotVerified");
    ...
    visible
      .map((supervisor) => {
        ...
        const score = state.recommendationScores.has(supervisorId)
          ? `${t("researchMatchLabel")} ${Math.round(state.recommendationScores.get(supervisorId) * 100)}%`
        ...
        const supervision = supervisionPresentation(supervisor);
        const availability = availabilityPresentation(supervisor);
        return `
          <tr>
            <td>
            ...
            <td>
              <div class="status-details">
                <div class="status-detail">
                  <span class="status-label">${escapeHTML(t("supervisionLabel"))}</span>
                  <span class="status-pill ${supervision.className}">${escapeHTML(supervision.label)}</span>
                </div>
                <div class="status-detail">
                  <span class="status-label">${escapeHTML(t("availabilityLabel"))}</span>
                  <span class="availability-value">${escapeHTML(availability)}</span>
                </div>
        ...
        ({ supervisor, percentage, explanation, components }) => {
          ...
          <article class="match-card">
            <header>
              ...
              <span class="match-score"><span>${escapeHTML(t("researchMatchLabel"))}</span><strong>${percentage}%</strong></span>
            </header>
            <p><strong>${escapeHTML(t("recommendedBecause"))}:</strong> ${escapeHTML(explanation)}${state.lang === "zh" ? "。" : "."}</p>
            <div class="match-context">
              <div class="match-context-item">
                <span>${escapeHTML(t("supervisionLabel"))}</span>
                <strong class="status-pill ${supervision.className}">${escapeHTML(supervision.label)}</strong>
              </div>
              <div class="match-context-item">
                <span>${escapeHTML(t("availabilityLabel"))}</span>
                <strong class="availability-value">${escapeHTML(availability)}</strong>
              </div>
            </div>
            <div class="tag-list">
